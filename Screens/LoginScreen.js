    ...
    <TouchableWithoutFeedback onPress={keyboardHide}>
      ...
      >
        <TouchableWithoutFeedback onPress={keyboardHide}>
          ...
          >
            <View style={{ ...styles.formTitleBox, marginTop: 32, height: 36 }}>
              ...
              >
                <TextInput
                  style={{
                    ...
                    backgroundColor: isInputFocus.email ? "#ffffff" : "#F6F6F6",
            ...
            <View style={styles.questionSignIn}>
              <TouchableOpacity style={styles.singInLink} activeOpacity={0.7}>
